          ...
          <div class="table-container">
            <client-only>
              <el-table :data="filterTableData" style="width: 100%" v-loading="pageLoading">
                ...
                <el-table-column prop="name" label="接口名称" width="150" show-overflow-tooltip />
                <el-table-column prop="alias" label="别名" width="120" show-overflow-tooltip />
                <el-table-column prop="state" label="状态" width="80">
                  <template #default="scope">
                    <el-tag :type="scope.row.state === '启用' ? 'success' : 'danger'" size="small">
                      {{ scope.row.state }}
                    </el-tag>
                  </template>
                </el-table-column>
                <el-table-column prop="prefixUrl" label="前缀地址" min-width="180" show-overflow-tooltip />
                <el-table-column prop="url" label="地址" width="80" show-overflow-tooltip />
                ...
                <el-table-column prop="keyState" label="Key验证" width="90">
                  <template #default="scope">
                    <el-tag :type="scope.row.keyState === '开启' ? 'warning' : 'info'" size="small">
                      {{ scope.row.keyState }}
                    </el-tag>
                  </template>
                </el-table-column>
                ...
                <el-table-column prop="keywords" label="接口关键词" min-width="200" show-overflow-tooltip />
              </el-table>

              <div class="pagination">
                <el-pagination :page-size="15" :pager-count="5" :total="totalRecords" v-model:current-page="page"

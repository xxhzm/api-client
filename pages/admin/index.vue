    ...
    <div class="right">
      ...
      <div class="main-container">
        <div class="info-container">
          <el-row :gutter="12">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" style="margin: 15px 0">
              <el-card style="padding: 5px 0" shadow="hover">您的秘钥：
                <el-tag type="primary" size="large">{{ userKey }}</el-tag>
                <el-button class="createKey" type="success" @click="createKey">重新生成秘钥</el-button>
                <el-button class="copykey" @click="copy(userKey)" type="primary">复制您的秘钥</el-button>
              </el-card>
            </el-col></el-row>

          <SystemInfo></SystemInfo>

          <el-row :gutter="12" style="margin-top: 20px; text-align: center" v-if="routeShow('/admin/FunctionBox')">
            <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
              <el-card style="padding: 5px 0" shadow="hover">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                  viewBox="0 0 1024 1024" style="color: rgb(105, 192, 255); font-size: 32px">
                  <path
            ...
            <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
              <el-card style="padding: 5px 0" shadow="hover">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                  viewBox="0 0 1024 1024" style="color: rgb(255, 192, 105); font-size: 32px">
                  <path
            ...
            <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
              <el-card style="padding: 5px 0" shadow="hover">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                  viewBox="0 0 1024 1024" style="color: rgb(255, 133, 192); font-size: 32px">
                  <path
          ...
          <el-row :gutter="12" style="margin-top: 20px; text-align: center" v-if="routeShow('/admin/FunctionBox')">
            <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
              <el-card style="padding: 5px 0" shadow="hover">
                <svg version="1.1" id="a" xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 1024 1024"
                  xml:space="preserve" style="color: rgb(92, 219, 211); font-size: 32px">
                  <path
            ...
            <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6">
              <el-card style="padding: 5px 0" shadow="hover" @click="navigateTo('/')">
                <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"
                  style="color: rgb(179, 127, 235); font-size: 32px">
                  <path fill="currentColor"
            ...
            <el-col :xs="24" :sm="12" :md="12" :lg="6" :xl="6" @click="$logout()">
              <el-card style="padding: 5px 0" shadow="hover">
                <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"

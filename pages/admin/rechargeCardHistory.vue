...
onMounted(() => {
  // getHistoryData() - this line was not in the original file, checking if I need to preserve something else.
  // Actually, looking at the read output, onMounted in rechargeCardHistory.vue just has getHistoryData().
})

      ...
      <div class="table-container">
        <client-only>
          ...
          >
            ...
            <el-table-column prop="ban_time" label="开始时间" min-width="200" />
            <el-table-column
              prop="expire_time"
              label="到期时间"
              min-width="200"
      ...
      >
            ...
            <div class="quick-reason-buttons">
              ...
              >
                ...
                <el-icon v-else-if="reason.icon === 'Warning'"
                  ><Warning
                /></el-icon>
                <el-icon v-else-if="reason.icon === 'Timer'"><Timer /></el-icon>
        ...
        <template #footer>
          <div class="dialog-footer">
            ...
            <el-button type="primary" @click="handleSaveBan"> 确认 </el-button>
          </div>
        </template>
      </el-dialog>
    </div>

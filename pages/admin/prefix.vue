...
onMounted(() => {
  // 页面加载时获取系统信息
  // getSystemInfo() - this line was not in the original file, checking if I need to preserve something else.
  // Actually, looking at the read output, onMounted in prefix.vue just has getData().
})
